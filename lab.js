...
let wiz = new Wizard("Merlin", 99999999, "Fireball");
...
//Code Here
const p1 = new Phone("Apple", "iPhone X", 256, "Gold", 699);
const p2 = new Phone("Apple", "iPhone 11", 512, "Gold", 799);
const p3 = new Phone("Apple", "iPhone 12", 1024, "Gold", 999);
/* 
...
console.log(colors2.background)
...
const car = new Vehicle(5, "black", 0);
/* 
...
class Boat extends Vehicle{
  constructor(name, type, isSeaworthy){
    super();
    this.name = name;
    this.type = type;
...
//Code Here
const b1 = new Boat("Anna Maria", "Ship", false);
b1.color = "Black"
...
//Code Here
b1.checkSeaworthiness();
/*
  Now run the performMaintenance method on your boat
*/

//Code Here 
b1.performMaintenance();
/*
